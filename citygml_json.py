...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_file', type=str, default='./sample/CityGML_3.gml', help='Input CityGML file')
    parser.add_argument('--output_file', type=str, default='./CityGML_3.json', help='Output JSON file')
 
    args = parser.parse_args()

    # convert CityGML to JSON
    convert_citygml_to_json(args.input_file, args.output_file)
